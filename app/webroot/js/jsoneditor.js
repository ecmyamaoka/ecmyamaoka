    ...
    if(this.format) {
      ...
      if(this.format === 'textarea') {
        ...
        this.input = this.theme.getTextareaInput();
          this.input.cols = this.schema.cols;
          this.input.rows = this.schema.rows;
      }
      // Range Input
...
JSONEditor.defaults.themes.bootstrap2 = JSONEditor.AbstractTheme.extend({
  ...
  getButton: function(text, icon, title) {
    ...
    el.className += ' btn btn-primary mr-1';
    return el;
  },
  getTable: function() {
    var el = document.createElement('table');
    el.className = 'table inventory-table';// table-bordered
    // el.style.width = 'auto';
