...
<?php
    if(isset($result)){
        foreach($result['data'] as $dt) {
            echo '<tr>';
            echo '<td>' . $dt['receive_order_row_goods_id'] . '</td>';
            echo '<td>' . $dt['receive_order_row_goods_name'] . '</td>';
            echo '<td>' . $dt['receive_order_row_quantity'] . '</td>';
            echo '<td>' . $dt['receive_order_row_unit_price'] . '</td>';
            echo '<td>' . $dt['receive_order_row_received_time_first_cost'] . '</td>';
            echo '<td>' . $dt['goods_id'] . '</td>';
            echo '<td>' . $dt['goods_name'] . '</td>';
            echo '<td>' . $dt['receive_order_shop_id'] . '</td>';
            echo '</tr>';
        }
    }
?>
