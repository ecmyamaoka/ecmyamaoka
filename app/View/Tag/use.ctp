...
<div class="row margin20">
    <div class="col-lg-12 col-md-12 col-xs-12">
        <?php
        echo $this->Html->link('戻る', 'index', array('class' => 'btn btn-outline-secondary'));
        ?>
    </div>
</div>
...
<div class="row margin20">
    <div class="col-lg-12 col-md-12 col-xs-12">
        <h3 class="title-h3">SPサイトにスクリプトを挿入する</h3>
        <div class="contents">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    ...
                    <img width="500" src="/service/img/tag/pc3.jpg">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    ...
                    <img width="500" src="/service/img/tag/sp2.jpg">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    ...
                    <img width="500" src="/service/img/tag/sp3.jpg">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12 col-xs-12 margintop20">
        <h3 class="title-h3">PCサイトにスクリプトを挿入する</h3>
        <div class="contents">
            <div class="card border-success mb-4" style="max-width: 50rem;">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    ...
                    <img width="500" src="/service/img/tag/pc1.jpg">
                    <div class="details">
                        　 ヘッダーコンテンツに、PC用スクリプトをいれてください<br>
                        複数テンプレート使用している場合、すべてのテンプレートにいれてください。
                    </div>
                    <img width="500" src="/service/img/tag/pc2.jpg"><br>
                </div>
            </div>
        </div>
    </div>
