...
$this->assign('title', 'タグマネージャー(R) 使用方法');
...
<div class="row margin20">
    <div class="col-lg-12 col-md-12 col-xs-12">
        ...
        <div class="contents">
            <?php
            echo $this->Form->submit('Ver 1.0.0 楽天GOLDにアップロード', array(
                'div' => false,
    ...
    <div class="col-lg-12 col-md-12 col-xs-12">
        ...
        <div class="contents">
            <div class="card border-success mb-4" style="max-width: 50rem;">
                ...
                <div class="card-body">
                    <p class="card-text">&lt;script ="" src="https://www.rakuten.ne.jp/gold/<?php echo $shopid; ?>/tagmng/tagmng.js?19122305" charset="UTF-8"&gt;&lt;/script =""&gt;</p>
                </div>
            </div>
            <?php 
    ...
    <div class="col-lg-12 col-md-12 col-xs-12 margintop20">
        ...
        <div class="contents">
            <div class="card border-success mb-4" style="max-width: 50rem;">
                ...
                <div class="card-body">
                    <p class="card-text">&lt;body ="" onpageshow="var script = document.createElement('script'); script.src = 'https://www.rakuten.ne.jp/gold/<?php echo $shopid; ?>/tagmng/tagmng.js?19122305'; script.charset = 'UTF-8'; document.body.appendChild(script);"&gt;&lt;/body =""&gt;</p>
                </div>
            </div>
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 margintop20">
        <h3 class="title-h3">新しいタグを追加する</h3>
        <div class="contents">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="details">[新しいタグを追加] からタグを追加します</div>
                    <img width="800" src="/img/tag/f1.jpg">
                </div>
            </div>
        </div>
        <h3 class="title-h3">HTMLを入力</h3>
        <div class="contents">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="details">タグ名(英語のみ),HTML,備考を入力し登録する</div>
                    <img width="800" src="/img/tag/f2.jpg">
                </div>
            </div>
        </div>
        <h3 class="title-h3">貼付タグを確認</h3>
        <div class="contents">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="details">貼付タグが登録されていることを確認</div>
                    <img width="800" src="/img/tag/f3.jpg">
                </div>
            </div>
        </div>
        <h3 class="title-h3">RMSに登録する</h3>
        <div class="contents">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="details">RMSに登録する</div>
                    <div class="details">登録できる場所</div>
                    <ul>
                    <li>カテゴリ説明文上</li>
                    <li>カテゴリ説明文下</li>
                    <li>スマートフォン用カテゴリ説明文</li>
                    <li>共通説明文（大）</li>
                    <li>ヘッダーコンテンツ</li>
                    <li>レフトナビゲーション</li>
                    <li>トップ説明文(1)</li>
                    <li>トップ説明文(2)</li>
                    <li>スマートフォン商品ページ共通説明文</li>
                    <li>スマートフォンカテゴリページ共通説明文 </li>
                    <li>商品説明文など</li>
                    </ul>
                    <img width="800" src="/img/tag/f4.jpg">
                </div>
            </div>
        </div>
        <h3 class="title-h3">確認する</h3>
        <div class="contents">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="details">登録されたページを確認してください</div>
                    <div class="details">緑点線枠にコンテンツが反映されています</div>
                    <img width="500" src="/img/tag/f10.jpg">
                </div>
            </div>
        </div>
